...
files_directory = "/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/loose_subsets_GA/all_papers" # Change
...
consolidated_results.append(compute_metrics_lgbt(unique_df, "unique_strict_researchers"))
...
output_path = "/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/96prc_subsets/GA_consol_metrics_all_papers.csv" # Change
