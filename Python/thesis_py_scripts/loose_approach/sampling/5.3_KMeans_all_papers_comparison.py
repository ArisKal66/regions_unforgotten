...
unique_csv_path = "/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/unique_loose96prc_researchers.csv" # Change
files_directory = "/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/loose_subsets_KMeans/all_papers" # Change
...
consolidated_results.append(compute_metrics_lgbt(unique_df, "unique_loose96prc_researchers"))
...
output_path = "/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/96prc_subsets/KMeans_consol_metrics_all_papers.csv" # Change
