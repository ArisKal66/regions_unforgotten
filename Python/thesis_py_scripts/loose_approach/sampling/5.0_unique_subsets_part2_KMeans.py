...
filtered_candidates = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/filtered_candidates_96prc.csv', sep=';') # Change
filtered_candidates = filtered_candidates.rename(columns={"author_name": "input_value"})

filtered_candidates_metadata = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/filtered_candidates_96prc_metadata.csv', sep=';') # Change
...
unique_strict_researchers_nonE = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/unique_loose96prc_researchers_nonC5.csv', sep=';') # Change
...
output_dir = '/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/loose_subsets_KMeans/papers_nonE/' # Change
...
kmeans = KMeans(n_clusters=n_clusters, random_state=np.random.randint(0, 60))
