...
filtered_candidates_tb_merged = filtered_candidates[['author_name','number_ids','max_date','min_date','max_date_interval','max_min_interval']]
...
output_dir = '/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/strict_subsets_GA/all_papers/' # Change
...
for it in range(iterations):
    ...
    for i in range(num_samples):
        ...
        output_file_path = os.path.join(output_dir, f'Iter_{it + 1}_APS_subset_{i + 1}_GA_all_papers.csv') # Change
