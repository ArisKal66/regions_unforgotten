...
filtered_candidates = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/filtered_candidates_96prc_all_papers.csv', sep=';')
...
results_df.to_csv(
    '/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/filtered_candidates_96prc_metadata_all_papers.csv', 
    sep=';', 
    index=False
)
