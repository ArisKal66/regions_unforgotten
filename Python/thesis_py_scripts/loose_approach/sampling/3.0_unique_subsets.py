...
loose96_paper_ids = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/loose96prc_paper_ids_nonC5.csv', sep=';')
...
result_df.to_csv(
    '/data2/aris/metadata/aps-dataset-metadata-2021/loose_appr/96prc/filtered_candidates_96prc.csv',
    sep=';',
    index=False
)
