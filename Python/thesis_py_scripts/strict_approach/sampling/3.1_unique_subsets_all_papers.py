...
# Load strict researchers and strict paper IDs
strict_paper_ids = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_paper_ids.csv', sep=';')
...
# Exclude matches from strict_paper_ids
...
result_df.to_csv(
    '/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_all_papers.csv',
    sep=';',
    index=False
)
