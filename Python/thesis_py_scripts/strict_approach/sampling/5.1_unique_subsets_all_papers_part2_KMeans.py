...
filtered_candidates = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_all_papers.csv', sep=';') # Change
filtered_candidates = filtered_candidates.rename(columns={"author_name": "input_value"})

filtered_candidates_metadata = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_metadata_all_papers.csv', sep=';') # Change
...
unique_strict_researchers_nonE = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/unique_strict_researchers.csv', sep=';') # Change
...
output_dir = '/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets_KMeans/all_papers/' # Change
...
for it in range(iterations):
    ...
    tolerance_max_date = 0.75 # changed
    tolerance_max_min = 1.1 # changed
