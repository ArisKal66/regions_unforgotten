...
filtered_candidates_all_papers = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_all_papers.csv', sep = ';')
...
filtered_candidates.to_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates.csv', sep = ';', index= False)