...
files_directory = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets/papers_nonE"
...
output_path = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets/consol_metrics_nonC5.csv"
