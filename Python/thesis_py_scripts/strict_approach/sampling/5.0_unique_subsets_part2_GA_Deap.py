...
filtered_candidates_metadata = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_metadata.csv', sep=';')
filtered_candidates_metadata = filtered_candidates_metadata.rename(columns={"input_value": "author_name"})

unique_strict_researchers_nonE = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/unique_strict_researchers_nonC5.csv', sep=';')
...
output_dir = '/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets_GA/papers_nonE/'
