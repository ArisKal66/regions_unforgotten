...
files_directory = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets_KMeans/all_papers" # Change
...
output_path = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets/KMeans_consol_metrics_all_papers.csv" # Change
