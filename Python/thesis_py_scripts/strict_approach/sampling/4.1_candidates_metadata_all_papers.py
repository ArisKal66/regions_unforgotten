...
filtered_candidates = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_all_papers.csv', sep=';')
...
results_df.to_csv(
    '/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/filtered_candidates_metadata_all_papers.csv', 
    sep=';', 
    index=False
)
