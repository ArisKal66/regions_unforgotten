...
unique_csv_path = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/unique_strict_researchers_nonC5.csv" # Change
files_directory = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets_KMeans/papers_nonE" # Change
...
consolidated_results.append(compute_metrics_lgbt(unique_df, "unique_strict_researchers_nonC5"))
...
output_path = "/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets/KMeans_consol_metrics_nonC5.csv" # Change
