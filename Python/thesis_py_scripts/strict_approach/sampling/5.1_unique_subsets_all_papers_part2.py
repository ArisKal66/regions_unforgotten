...
unique_strict_researchers = pd.read_csv('/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/unique_strict_researchers.csv', sep=';') # Change
...
output_dir = '/data2/aris/metadata/aps-dataset-metadata-2021/strict_appr/strict_subsets/all_papers/' # Change
