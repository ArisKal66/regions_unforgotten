...
# Paths
lgbtq_path = "D:/Downloads/thesis/final/strict_appr/unique_strict_researchers.csv"
ga_base_path = "D:/Downloads/thesis/final/strict_appr/strict_subsets/all_papers/"

# Files and fields
ga_files = [
    "Iter_7_APS_subset_3_all_papers.csv",
    "Iter_4_APS_subset_4_all_papers.csv",
    "Iter_5_APS_subset_4_all_papers.csv",
    "Iter_2_APS_subset_2_all_papers.csv",
    "Iter_4_APS_subset_1_all_papers.csv"
]
...
results_df.to_csv("D:/Downloads/thesis/final/statistical_tests_results_random.csv", index=False, sep =";")
